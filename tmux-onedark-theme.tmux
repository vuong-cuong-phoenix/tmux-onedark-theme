...
onedark_red="#e06c75"
onedark_white="#fcfcfc"
onedark_green="#98c379"
onedark_visual_grey="#3e4452"
onedark_common_grey="#808080"
...
set "window-status-format" "#[fg=$onedark_black,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_common_grey,bg=$onedark_visual_grey,nobold] #I  #W #[fg=$onedark_visual_grey,bg=$onedark_black,nobold,nounderscore,noitalics]"
set "window-status-current-format" "#[fg=$onedark_black,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_green,bg=$onedark_visual_grey,bold] #I  #W #[fg=$onedark_visual_grey,bg=$onedark_black,nobold,nounderscore,noitalics]"
